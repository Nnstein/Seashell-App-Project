...
$webMvcFolder = Join-Path $slnFolder "src/Seashell.Resort.Web.Mvc"
$webPublicFolder = Join-Path $slnFolder "src/Seashell.Resort.Web.Public"
...
dotnet restore Seashell.Resort.Web.sln
