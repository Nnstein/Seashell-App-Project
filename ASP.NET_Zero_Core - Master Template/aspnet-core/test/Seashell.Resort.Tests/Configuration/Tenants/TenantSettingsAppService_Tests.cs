...
using Seashell.Resort.Configuration.Tenants;
using Shouldly;
using Xunit;

namespace Seashell.Resort.Tests.Configuration.Tenants
{
    ...
    public class TenantSettingsAppService_Tests : AppTestBase
    {
        ...
        public async Task Should_Change_UserManagement_Settings()
        {
            ...
            settings.UserManagement.CaptchaSettings.UseCaptchaOnRegistration.ShouldBe(true);
            ...
            settings.UserManagement.CaptchaSettings.UseCaptchaOnRegistration = false;
