...
namespace Seashell.Resort.Tests.Editions
{
    ...
    public class EditionAppService_Tests : AppTestBase
    {
        ...
        public async Task Should_Create_Edition()
        {
            ...
            var testCheckFeature = output.FeatureValues.FirstOrDefault(f => f.Name == AppFeatures.TestCheckFeature);
            if (testCheckFeature != null)
            {
                testCheckFeature.Value = testCheckFeature.Value = "true";
            }
            ...
            await UsingDbContextAsync(async context =>
            {
                ...
                if (testCheckFeature != null)
                {
                    var sampleFeatureValue = context.EditionFeatureSettings.FirstOrDefault(s => s.EditionId == premiumEditon.Id && s.Name == AppFeatures.TestCheckFeature);
