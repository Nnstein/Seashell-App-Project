...
using Seashell.Resort.Test.Base.TestData;
...
namespace Seashell.Resort.Test.Base
{
    ...
    public abstract class AppTestBase<T> : AbpIntegratedTestBase<T> where T : AbpModule
    {
        ...
        protected TResult UsingDbContext<TResult>(Func<AbpZeroTemplateDbContext, TResult> func)
        {
            return UsingDbContext(AbpSession.TenantId, func);
        }

        protected Task<TResult> UsingDbContextAsync<TResult>(Func<AbpZeroTemplateDbContext, Task<TResult>> func)
        {
        ...
        protected TResult UsingDbContext<TResult>(int? tenantId, Func<AbpZeroTemplateDbContext, TResult> func)
        {
            TResult result;
