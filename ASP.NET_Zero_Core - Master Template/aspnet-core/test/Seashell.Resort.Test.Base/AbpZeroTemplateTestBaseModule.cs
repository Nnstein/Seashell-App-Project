...
using Seashell.Resort.Test.Base.DependencyInjection;
using Seashell.Resort.Test.Base.UiCustomization;
using Seashell.Resort.Test.Base.Url;
using Seashell.Resort.Test.Base.Web;
...
namespace Seashell.Resort.Test.Base
{
    ...
    public class AbpZeroTemplateTestBaseModule : AbpModule
    {
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.EntityHistory.Selectors.Add("Seashell.ResortEntities", typeof(User), typeof(Tenant));
        }
