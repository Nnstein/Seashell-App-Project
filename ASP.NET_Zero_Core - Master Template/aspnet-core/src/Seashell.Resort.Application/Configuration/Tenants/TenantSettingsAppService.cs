...
using Seashell.Resort.Configuration.Tenants.Dto;
using Seashell.Resort.Security;
using Seashell.Resort.Storage;
using Seashell.Resort.Timing;

namespace Seashell.Resort.Configuration.Tenants
{
    ...
    public class TenantSettingsAppService : SettingsAppServiceBase, ITenantSettingsAppService
    {
        ...
        {
            if (_multiTenancyConfig.IsEnabled && !AbpZeroTemplateConsts.AllowTenantsToChangeEmailSettings)
            {
                return;
            }
