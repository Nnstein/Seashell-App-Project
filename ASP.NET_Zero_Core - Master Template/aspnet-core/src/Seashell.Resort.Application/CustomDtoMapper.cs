...
using Seashell.Resort.EntityChanges;
...
namespace Seashell.Resort
{
    internal static class CustomDtoMapper
    {
        public static void CreateMappings(IMapperConfigurationExpression configuration)
        {
            ...
            //RoomType
            configuration.CreateMap<RoomType, RoomTypeDto>().ReverseMap();
            configuration.CreateMap<RoomType, RoomTypeListDto>();
            configuration.CreateMap<CreateRoomTypeDto, RoomType>();
            configuration.CreateMap<UpdateRoomTypeDto, RoomType>();
