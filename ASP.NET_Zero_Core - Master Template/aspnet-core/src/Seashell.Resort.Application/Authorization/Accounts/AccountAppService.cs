...
using Seashell.Resort.Authentication.PasswordlessLogin;
using Seashell.Resort.Authorization.PasswordlessLogin;

namespace Seashell.Resort.Authorization.Accounts
{
    public class AccountAppService : AbpZeroTemplateAppServiceBase, IAccountAppService
    {
        ...
        private async Task SendSmsPasswordlessCode(string phoneNumber)
        {
            ...
            var message = string.Format(L("PasswordlessLogin_SmsMessage", AbpZeroTemplateConsts.ProductName, code));
