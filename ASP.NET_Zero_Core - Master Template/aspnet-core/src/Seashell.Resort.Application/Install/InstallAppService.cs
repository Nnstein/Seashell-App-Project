...
using Seashell.Resort.Migrations.Seed;
using Seashell.Resort.Migrations.Seed.Host;
...
namespace Seashell.Resort.Install
{
    ...
    public class InstallAppService : AbpZeroTemplateAppServiceBase, IInstallAppService
    {
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{AbpZeroTemplateConsts.ConnectionStringName}", constring);
        }
