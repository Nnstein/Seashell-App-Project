...
using Seashell.Resort.Core.Base;
using Seashell.Resort.Dto;
using Seashell.Resort.Types;
using Seashell.Resort.Core.Extensions;
using GraphQL;

namespace Seashell.Resort.Queries
{
    public class UserQuery : AbpZeroTemplateQueryBase<UserPagedResultGraphType, PagedResultDto<UserDto>>
    {
