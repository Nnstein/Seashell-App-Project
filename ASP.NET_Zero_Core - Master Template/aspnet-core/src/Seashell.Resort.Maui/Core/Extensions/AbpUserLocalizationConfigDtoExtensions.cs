...
namespace Seashell.Resort.Maui.Core.Extensions
{
    public static class AbpUserLocalizationConfigDtoExtensions
    {
        ...
        {
            return Localize(userLocalizationConfig, key, Seashell.Resort.AbpZeroTemplateConsts.LocalizationSourceName, args);
        }
    }
}
