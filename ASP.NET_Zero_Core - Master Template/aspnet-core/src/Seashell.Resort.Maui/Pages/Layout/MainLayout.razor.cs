...
using Seashell.Resort.Maui.Core.Helpers;
using Seashell.Resort.Maui.Core.Localization;
using Seashell.Resort.Maui.Services.Account;
using Seashell.Resort.Maui.Services.Navigation;
using Seashell.Resort.Maui.Services.Tenants;
using Seashell.Resort.Maui.Services.UI;
using Plugin.Connectivity;

#if ANDROID
using Seashell.Resort.Maui.Core.Platforms.Android.HttpClient;
#endif
#if IOS
using Seashell.Resort.Maui.Core.Platforms.iOS.HttpClient;
#endif
