...
namespace Seashell.Resort.Web.Areas.AppAreaName.Views.Shared.Themes.Theme7.Components.AppAreaNameTheme7Footer
{
    public class AppAreaNameTheme7FooterViewComponent : AbpZeroTemplateViewComponent
    {
