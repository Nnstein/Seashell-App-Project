...
namespace Seashell.Resort.Web.Areas.AppAreaName.Views.Shared.Themes.Theme2.Components.AppAreaNameTheme2Brand
{
    public class AppAreaNameTheme2BrandViewComponent : AbpZeroTemplateViewComponent
    {
