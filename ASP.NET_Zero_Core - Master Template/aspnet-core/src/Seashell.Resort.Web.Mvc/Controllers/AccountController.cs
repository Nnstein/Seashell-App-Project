...
using Seashell.Resort.Debugging;
    ...
    public class AccountController : AbpZeroTemplateControllerBase
    {
            ...
            string returnUrlHash = "", string ss = "")
        {
            ...
            if (loginResult.User.ShouldChangePasswordOnNextLogin)
            {
                ...
                var expireDate =
                    Uri.EscapeDataString(Clock.Now.AddHours(1).ToString(AbpZeroTemplateConsts.DateTimeOffsetFormat));
