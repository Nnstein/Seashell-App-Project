...
using Seashell.Resort.Configure;
using Seashell.Resort.EntityFrameworkCore;
using Seashell.Resort.Identity;
using Seashell.Resort.Schemas;
using Seashell.Resort.Web.Common;
using Seashell.Resort.Web.Resources;
using Swashbuckle.AspNetCore.Swagger;
using Seashell.Resort.Web.Swagger;
using Stripe;
...
using Seashell.Resort.Web.HealthCheck;
using Owl.reCAPTCHA;
using Microsoft.AspNetCore.Server.Kestrel.Https;
using Microsoft.Extensions.DependencyInjection.Extensions;
using Seashell.Resort.Web.Extensions;
using Seashell.Resort.Web.MultiTenancy;
using Seashell.Resort.Web.OpenIddict;
using SecurityStampValidatorCallback = Seashell.Resort.Identity.SecurityStampValidatorCallback;
using Abp.AspNetCore.OpenIddict;

namespace Seashell.Resort.Web.Startup
{
    public class Startup
    {
            ...
            if (WebConsts.SwaggerUiEnabled)
            {
                ...
                app.UseSwaggerUI(options =>
                {
                    ...
                    options.IndexStream = () => Assembly.GetExecutingAssembly()
                        .GetManifestResourceStream("Seashell.Resort.Web.wwwroot.swagger.ui.index.html");
        ...
        private void ConfigureSwagger(IServiceCollection services)
        {
            services.AddSwaggerGen(options =>
            {
                ...
                var applicationXml = $"Seashell.Resort.Application.xml";
                var applicationXmlPath = Path.Combine(AppContext.BaseDirectory, applicationXml);
                options.IncludeXmlComments(applicationXmlPath);

                var webCoreXmlFile = $"Seashell.Resort.Web.Core.xml";
