...
namespace Seashell.Resort.Web.Authentication.JwtBearer
{
    public class AbpZeroTemplateAsyncJwtBearerHandler : AuthenticationHandler<AsyncJwtBearerOptions>
    {
        ...
        /// </summary>
        /// <inheritdoc />
        public AbpZeroTemplateAsyncJwtBearerHandler(IOptionsMonitor<AsyncJwtBearerOptions> options,
