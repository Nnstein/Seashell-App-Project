...
/// </summary>
public static class AbpZeroTemplateJwtBearerExtensions
{
    /// <summary>
    ...
    public static AuthenticationBuilder AddAbpAsyncJwtBearer(this AuthenticationBuilder builder, string authenticationScheme, string? displayName, Action<AsyncJwtBearerOptions> configureOptions)
    {
        ...
        return builder.AddScheme<AsyncJwtBearerOptions, AbpZeroTemplateAsyncJwtBearerHandler>(authenticationScheme, displayName, configureOptions);
    }
}
