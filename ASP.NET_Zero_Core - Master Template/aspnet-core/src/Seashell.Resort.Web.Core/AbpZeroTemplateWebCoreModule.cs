...
using Seashell.Resort.Web.Configuration;
using Seashell.Resort.Web.DashboardCustomization;
using Abp.Extensions;
using Abp.HtmlSanitizer;
using Abp.HtmlSanitizer.Configuration;
using Seashell.Resort.Authorization.Accounts;

namespace Seashell.Resort.Web
{
    [DependsOn(
    ...
    public class AbpZeroTemplateWebCoreModule : AbpModule
    {
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(AbpZeroTemplateWebCoreModule).Assembly);
        }
