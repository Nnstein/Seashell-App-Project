...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Seashell.Resort.Authorization.Delegation.UserDelegation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Seashell.Resort.Authorization.Users.RecentPassword", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Seashell.Resort.MultiTenancy.Payments.SubscriptionPaymentProduct", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Seashell.Resort.OpenIddict.Applications.OpenIddictApplication", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Seashell.Resort.OpenIddict.Authorizations.OpenIddictAuthorization", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Seashell.Resort.OpenIddict.Scopes.OpenIddictScope", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Seashell.Resort.OpenIddict.Tokens.OpenIddictToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Seashell.Resort.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Seashell.Resort.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Seashell.Resort.MultiTenancy.Payments.SubscriptionPaymentProduct", b =>
                {
                    b.HasOne("Seashell.Resort.MultiTenancy.Payments.SubscriptionPayment", null)
            ...
            modelBuilder.Entity("Seashell.Resort.OpenIddict.Authorizations.OpenIddictAuthorization", b =>
                {
                    b.HasOne("Seashell.Resort.OpenIddict.Applications.OpenIddictApplication", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Seashell.Resort.OpenIddict.Tokens.OpenIddictToken", b =>
                {
                    ...
                    b.HasOne("Seashell.Resort.OpenIddict.Authorizations.OpenIddictAuthorization", null)
                        .WithMany()
