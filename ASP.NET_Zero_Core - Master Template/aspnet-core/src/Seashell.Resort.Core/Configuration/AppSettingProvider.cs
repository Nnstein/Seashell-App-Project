...
using Seashell.Resort.Authentication;
    ...
    public class AppSettingProvider : SettingProvider
    {
        ...
        public Dashboard GetDefaultMvcHostDashboardView()
        {
            ...
            return new Dashboard
            {
                ...
                Pages = new List<Page>
                {
                    new Page($"Page_{AbpZeroTemplateDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard}_{AbpZeroTemplateDashboardCustomizationConsts.DefaultPageUniqueName}_{1}")
                    {
        ...
        public Dashboard GetDefaultMvcTenantDashboardView()
        {
            ...
            return new Dashboard
            {
                ...
                Pages = new List<Page>
                {
                    new Page($"Page_{AbpZeroTemplateDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard}_{AbpZeroTemplateDashboardCustomizationConsts.DefaultPageUniqueName}_{1}")
                    {
                        Name = AbpZeroTemplateDashboardCustomizationConsts.DefaultPageName,
                        Widgets = new List<Widget>
                        {
