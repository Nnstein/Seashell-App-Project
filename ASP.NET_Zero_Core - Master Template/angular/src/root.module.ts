...
import { DEFAULT_CURRENCY_CODE, Injector, LOCALE_ID, NgModule, inject, provideAppInitializer } from '@angular/core';
...
export function appInitializerFactory() {
    return () => {
        ...
        let platformLocation = injector.get(PlatformLocation);
